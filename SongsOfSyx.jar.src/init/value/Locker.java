...
/*     */   }
/*     */   
/*     */   public abstract boolean inUnlocked(T paramT);
/*     */   
/*     */   public double progress(T t) {
/*  22 */     return (inUnlocked(t) ? true : false);
/*     */   }
/*     */   
...
/*  27 */     b.add(this.icon);
/*  28 */     GText te = b.text();
/*  29 */     te.setMaxWidth(250);
/*  30 */     te.setMultipleLines(true);
/*     */ 
/*     */     
/*  33 */     if (inUnlocked(t)) {
/*  34 */       te.normalify2().add(this.name);
/*     */     } else {
/*  36 */       te.errorify().add(this.name);
/*     */     } 
/*  38 */     te.adjustWidth();
/*  39 */     b.add((SPRITE)te);
/*  40 */     b.NL();
/*     */   }
/*     */   
/*     */   static final class LockerValue<T>
/*     */     extends Locker<T> {
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\init\value\Locker.class
