...
/*     */   final Tile s24;
/*     */   final Tile s32;
/*  24 */   private final TextureCoords coos = new TextureCoords();
/*     */   
/*     */   Optimizer(FileGetter g, SnakeImage source) throws IOException {
/*  27 */     i = this;
/*  28 */     int y1 = 0;
/*  29 */     this.s8 = new Tile(y1, source.width, 8, g.lastInt(5));
/*  30 */     y1 += 8 * this.s8.rows;
/*  31 */     this.s16 = new Tile(y1, source.width, 16, g.lastInt(4));
/*  32 */     y1 += 16 * this.s16.rows;
/*  33 */     this.s32 = new Tile(y1, source.width, 32, g.lastInt(3));
/*  34 */     y1 += 32 * this.s32.rows;
/*  35 */     this.s24 = new Tile(y1, source.width, 24, g.lastInt(2));
/*  36 */     optimize(source);
/*     */   }
/*     */   
...
/*  50 */         return i.s32;
/*     */     } 
/*  52 */     throw new RuntimeException("" + tileSize);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   private static void optimize(SnakeImage source) {
/*  58 */     LOG.ln("TILE OPTIMIZING");
/*  59 */     i.s8.optimize(source);
/*  60 */     i.s16.optimize(source);
/*  61 */     i.s24.optimize(source);
/*  62 */     i.s32.optimize(source);
/*     */   }
/*     */ 
/*     */   
/*     */   final class Tile
...
/*     */     }
/*     */     private static final int widths = 1; private static final int offY1 = 2; private static final int heights = 3; private final int tiles; private final int tScroll; private final int tMask; private final int rows;
...
/*     */   
/*     */   public void save(FilePutter file) {
/* 270 */     this.s8.save(file);
/* 271 */     this.s16.save(file);
/* 272 */     this.s24.save(file);
/* 273 */     this.s32.save(file);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void load(FileGetter file) throws IOException {
/* 279 */     this.s8.load(file);
/* 280 */     this.s16.load(file);
/* 281 */     this.s24.load(file);
/* 282 */     this.s32.load(file);
/*     */   }
/*     */   
/*     */   public void clear() {}
/*     */ }
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar\\util\spritecomposer\Optimizer.class
