...
/*     */ {
/*  22 */   private static KeyMap<LinkedList<ScriptLoad>> cache = new KeyMap();
/*     */   
...
/*  31 */     this.className = cn;
/*  32 */     this.file = file;
/*  33 */     this.key = file + "->" + file;
/*     */   }
/*     */   
/*     */   static LIST<ScriptLoad> get(String script) {
/*  37 */     return (new Init()).compileScripts(new String[] { script });
/*     */   }
/*     */   
/*     */   static LIST<ScriptLoad> getAll() {
/*  41 */     return (LIST<ScriptLoad>)new ArrayList((Iterable)(new Init()).compileScripts((PATHS.SCRIPT()).jar.getFiles()));
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\script\ScriptLoad.class
