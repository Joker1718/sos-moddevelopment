...
/*     */   implements Profiler
/*     */ {
/*  45 */   private final ArrayList<Prof> entries = new ArrayList(256); private LinkedHashMap<Class<?>, Prof> map; private long ss; private int tab; private boolean cpu;
/*     */   null() {
/*  47 */     while (this.entries.hasRoom()) {
/*  48 */       this.entries.add(new Prof());
/*     */     }
/*     */     
/*  51 */     this.map = new LinkedHashMap<>();
/*  52 */     this.ss = -1L;
/*  53 */     this.tab = 0;
/*  54 */     this.cpu = false;
/*  55 */     this.mem = true;
/*  56 */     this.keepnops = false;
/*  57 */     this.outliners = false;
/*     */     
/*  59 */     this.omap = new LinkedHashMap<>();
/*     */   }
/*     */   private boolean mem; private boolean keepnops; private boolean outliners; private LinkedHashMap<Class<?>, Out> omap;
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\game\debug\Profiler$2.class
