...
/*     */ 
/*     */ final class GUI {
/*  26 */   public static final COLOR c_hover = (COLOR)new ColorShifting((COLOR)new ColorImp(127, 127, 65), 
/*  27 */       (COLOR)new ColorImp(110, 90, 45));
/*  28 */   public static final COLOR c_selected = (COLOR)new ColorImp(80, 110, 65);
/*  29 */   public static final COLOR c_hover_selected = (COLOR)new ColorImp(100, 128, 80);
/*  30 */   public static final COLOR c_inactive = COLOR.BROWN;
/*  31 */   public static final COLOR c_unclickable = (COLOR)new ColorImp(110, 90, 45);
/*  32 */   public static final COLOR c_label = (COLOR)new ColorImp(127, 127, 65);
/*  33 */   public static final COLOR c_border = (COLOR)new ColorImp(100, 90, 80);
/*     */ 
/*     */   
/*     */   GUI(RES res) {}
/*     */   
...
/*     */   }
/*     */   
/*     */   public static class BSpriteBig
/*     */     extends Button
/*     */   {
/*     */     BSpriteBig(SPRITE s) {
/*  87 */       super(sp(s));
...
/* 205 */       this.t = (new Text(res.font, text)).setScale(1.0D);
/* 206 */       this.body.setDim(this.t.width(), (this.t.height() + 8));
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public void render(SPRITE_RENDERER r, float ds) {
/* 212 */       GUI.c_label.bind();
/* 213 */       this.t.render(r, this.body.x1(), this.body.y1());
/* 214 */       GUI.c_label.render(r, this.body.x1(), this.body.x2(), this.body.y2() - 4, this.body.y2() - 3);
/* 215 */       COLOR.unbind();
/*     */     }
/*     */   }
/*     */ 
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\launcher\GUI.class
