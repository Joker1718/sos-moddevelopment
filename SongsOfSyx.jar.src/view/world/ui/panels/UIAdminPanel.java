...
/*    */   public UIAdminPanel(final ISidePanels panels) {
/* 25 */     titleSet((BOOSTABLES.CIVICS()).GOV.name);
/*    */     
/* 27 */     this.section.addRelBody(2, DIR.S, (RENDEROBJ)(new GStat()
/*    */         {
...
/* 33 */         }).hv(Dic.¤¤Available));
/*    */     
/* 35 */     this.section.body().incrH(16.0D);
/*    */ 
/*    */     
/* 38 */     GTableBuilder bu = new GTableBuilder()
/*    */       {
/*    */         public int nrOFEntries()
/*    */         {
/* 42 */           return FACTIONS.player().realm().regions() - 1;
/*    */         }
/*    */       };
/*    */ 
/*    */     
/* 47 */     bu.column(null, 250, new GTableBuilder.GRowBuilder()
/*    */         {
...
/*    */         });
/*    */     
/* 99 */     this.section.addRelBody(16, DIR.S, (RENDEROBJ)bu.createHeight(HEIGHT - this.section.body().height() - 32, true));
/*    */   }
/*    */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\worl\\ui\panels\UIAdminPanel.class
