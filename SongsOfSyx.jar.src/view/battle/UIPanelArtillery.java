...
/*     */ 
/*     */ final class UIPanelArtillery
/*     */   extends ISidePanel
/*     */ {
/*     */   private final CatSelection selection;
/*  29 */   private final ArrayListResize<ArtilleryInstance> all = new ArrayListResize(256);
/*     */   
/*  31 */   private static int width = 160;
/*     */   
/*     */   public UIPanelArtillery(final Army army, final CatSelection selection) {
/*  34 */     titleSet(Dic.¤¤Artillery);
/*  35 */     this.selection = selection;
/*  36 */     GTableBuilder builder = new GTableBuilder()
/*     */       {
...
/*     */       };
/*     */     
/*  55 */     builder.column(null, width, new GTableBuilder.GRowBuilder()
/*     */         {
/*     */           public RENDEROBJ build(GETTER<Integer> ier)
/*     */           {
/*  59 */             return (RENDEROBJ)new UIPanelArtillery.CatButton(ier, selection);
/*     */           }
/*     */         });
/*     */     
/*  63 */     this.section.add((RENDEROBJ)builder.createHeight(HEIGHT, false));
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\battle\UIPanelArtillery.class
