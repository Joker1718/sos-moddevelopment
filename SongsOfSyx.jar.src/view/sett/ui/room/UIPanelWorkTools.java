...
/*  27 */   private static CharSequence ¤¤level = "Current Available Max Level:";
/*     */   
/*     */   static {
/*  30 */     D.ts(UIPanelWorkTools.class);
/*     */   }
/*     */ 
/*     */   
/*     */   public UIPanelWorkTools(final RoomEquip work) {
/*  35 */     this.section.add((RENDEROBJ)(new GStat()
/*     */         {
/*     */           public void update(GText text)
/*     */           {
/*  39 */             GFORMAT.iofkInv(text, work.currentTotal(), work.neededTotal());
/*     */           }
/*  41 */         }).increase().r(DIR.N));
/*     */     
/*  43 */     UIPanelUtil.BlueprintList blueprintList = new UIPanelUtil.BlueprintList(HEIGHT - this.section.body().y2() - 16)
/*     */       {
...
/*     */       };
/*     */     
/* 153 */     this.section.addRelBody(8, DIR.S, (RENDEROBJ)blueprintList);
/*     */ 
/*     */     
/* 156 */     titleSet(work.resource.names);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\UIPanelWorkTools.class
