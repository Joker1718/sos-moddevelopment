...
/*  53 */   private static CharSequence ¤¤delete = "¤Are you sure you want to delete this room?";
/*  54 */   private static CharSequence ¤¤ActivateDesc = "¤Turn on/off activity for this room.";
/*  55 */   private static CharSequence ¤¤Refurnish = "¤Refurnish Room. WARNING: All room progress will be lost and all employees fired.";
/*     */   
/*     */   static {
/*  58 */     D.ts(UIRoom.class);
/*     */   }
/*     */   
/*     */   @SafeVarargs
/*     */   public UIRoom(RoomBlueprint p, UIRoomModule... appliers) {
/*  63 */     this.appliers = appliers;
/*  64 */     if (p instanceof settlement.room.military.artillery.ROOM_ARTILLERY) {
/*  65 */       this.detail = null;
/*  66 */       this.table = null;
/*  67 */       this.clicker = null;
/*  68 */     } else if (p instanceof RoomBlueprintIns) {
/*  69 */       this.detail = new Detail((RoomBlueprintIns)p, appliers);
/*  70 */       this.table = new UIRoomTable((RoomBlueprintIns)p, this, appliers);
/*  71 */       this.clicker = makeClicker((RoomBlueprintImp)p, appliers);
/*  72 */     } else if (p instanceof RoomBlueprintImp) {
/*  73 */       this.detail = null;
/*  74 */       this.table = null;
/*  75 */       this.clicker = makeClicker((RoomBlueprintImp)p, appliers);
/*     */     } else {
/*  77 */       this.detail = null;
/*  78 */       this.table = null;
/*  79 */       this.clicker = null;
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public boolean can() {
/*  86 */     return (this.detail != null);
/*     */   }
/*     */   
/*     */   public ISidePanel detail(RoomInstance ins) {
/*  90 */     this.detail.room = ins;
/*  91 */     this.detail.titleSet((ins.blueprintI()).info.name);
/*  92 */     this.detail.panelTitle.text().clear().add((CharSequence)ins.name());
/*  93 */     return this.detail;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public RoomInstance detailIns() {
/*  99 */     return this.detail.room;
/*     */   }
/*     */   
/* 102 */   private static final ArrayList<CharSequence> errors = new ArrayList(128);
/* 103 */   private static final ArrayList<CharSequence> warnings = new ArrayList(128);
/* 104 */   private static final Stack<Str> free = new Stack(128);
/* 105 */   private static final ArrayList<Str> tmps = new ArrayList(128);
/*     */   static {
/* 107 */     while (tmps.hasRoom())
/* 108 */       tmps.add(new Str(64)); 
/*     */   }
/*     */   private static void errorPrep() {
/* 111 */     errors.clearSloppy();
/* 112 */     warnings.clearSloppy();
/* 113 */     free.clear();
/* 114 */     for (Str s : tmps) {
/* 115 */       s.clear();
/* 116 */       free.push(s);
...
/* 122 */     if (i.icon() == null) {
/* 123 */       throw new RuntimeException(String.valueOf(i));
/*     */     }
/* 125 */     box.add(i.icon());
/* 126 */     box.add((SPRITE)box.text().add(i.name(rx, ry)));
/*     */     
/* 128 */     box.NL(2); byte b; int j;
/*     */     UIRoomModule[] arrayOfUIRoomModule;
/* 130 */     for (j = (arrayOfUIRoomModule = this.appliers).length, b = 0; b < j; ) { UIRoomModule a = arrayOfUIRoomModule[b];
/* 131 */       a.hover(box, i, rx, ry);
/*     */       b++; }
/*     */     
/* 134 */     box.NL(2);
/*     */     
/* 136 */     errorPrep();
/* 137 */     for (j = (arrayOfUIRoomModule = this.appliers).length, b = 0; b < j; ) { UIRoomModule a = arrayOfUIRoomModule[b];
/* 138 */       a.problem(free, (LISTE<CharSequence>)errors, (LISTE<CharSequence>)warnings, i, rx, ry);
/*     */       
/*     */       b++; }
/*     */     
/* 142 */     for (CharSequence e : errors) {
/* 143 */       box.add((SPRITE)(UI.icons()).s.flag, (GCOLOR.MAP()).BAD);
/* 144 */       box.error(e);
/* 145 */       box.NL();
/*     */     } 
/* 147 */     for (CharSequence e : warnings) {
/* 148 */       box.add((SPRITE)(UI.icons()).s.alert, (GCOLOR.MAP()).SOSO);
/* 149 */       box.error(e);
/* 150 */       box.NL();
/*     */     } 
/*     */   }
...
/* 155 */     errorPrep(); byte b; int j; UIRoomModule[] arrayOfUIRoomModule;
/* 156 */     for (j = (arrayOfUIRoomModule = this.appliers).length, b = 0; b < j; ) { UIRoomModule a = arrayOfUIRoomModule[b];
/* 157 */       a.problem(free, (LISTE<CharSequence>)errors, (LISTE<CharSequence>)warnings, i, rx, ry);
/*     */       b++; }
/*     */     
/* 160 */     return (errors.size() > 0);
/*     */   }
/*     */   
/*     */   boolean warning(Room i, int rx, int ry) {
/* 164 */     errorPrep(); byte b; int j; UIRoomModule[] arrayOfUIRoomModule;
/* 165 */     for (j = (arrayOfUIRoomModule = this.appliers).length, b = 0; b < j; ) { UIRoomModule a = arrayOfUIRoomModule[b];
/* 166 */       a.problem(free, (LISTE<CharSequence>)errors, (LISTE<CharSequence>)warnings, i, rx, ry);
/*     */       b++; }
/*     */     
/* 169 */     return (warnings.size() > 0);
/*     */   }
/*     */ 
/*     */   
/*     */   CLICKABLE makeClicker(RoomBlueprintImp blueprint, UIRoomModule... appliers) {
/* 174 */     return (CLICKABLE)new Row(blueprint);
/*     */   }
/*     */   
/*     */   private class Row
...
/* 215 */       if (hovered() == null || !(hovered() instanceof CLICKABLE)) {
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\UIRoom.class
