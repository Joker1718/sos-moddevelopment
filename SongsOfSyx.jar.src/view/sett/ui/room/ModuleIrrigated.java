...
/*    */ import util.text.D;
/*    */ 
/*    */ final class ModuleIrrigated implements Modules.ModuleMaker {
/* 24 */   private final CharSequence ¤¤Desc = "¤This room depends on the moisture of its ground tiles. All tiles have a default moisture percentage, which can be boosted by sweet water access emanating from natural bodies of water and canals. This room needs an average moisture of {0}% to get a full boost. Current average is {1}%, which will result in a {2}% target value. The current value of {3}% will take some time to move to the target.";
/*    */ 
/*    */   
...
/* 34 */     if (p instanceof RoomIrrigated.ROOM_IRRIGATED) {
/* 35 */       l.add(new I((RoomIrrigated.ROOM_IRRIGATED)p));
/*    */     }
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\ModuleIrrigated.class
