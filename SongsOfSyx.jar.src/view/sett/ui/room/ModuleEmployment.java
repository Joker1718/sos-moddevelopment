...
/*     */ 
/*     */ final class ModuleEmployment implements Modules.ModuleMaker {
/*  60 */   private final CharSequence ¤¤EMPLOYEES_DESC = "¤Actual employees / Target Employees. When you set the target, unemployed people will soon sign up and start working the room. Without sufficient workers, or if subjects are prevented from working due to priorities, a room will perform poorly. The worker amount isn't fixed. It can vary greatly depending on how the room is laid out, and how well your city is planned. The tool-tip when creating a room will offer a guess of how many workers will be required in an average city.";
/*  61 */   private final CharSequence ¤¤WORKLOAD_LOW = "¤Workload is low";
/*  62 */   private final CharSequence ¤¤SHIFT_START = "¤What time the work shift starts.";
/*  63 */   private final CharSequence ¤¤SHIFT_NIGHT = "¤This room is employed all hours of the day.";
/*  64 */   private final CharSequence ¤¤WORKERS_INC = "¤Workers +{0}";
/*  65 */   private final CharSequence ¤¤WORKERS_DEC = "¤Workers -{0}";
/*  66 */   private final CharSequence ¤¤WORKERS_NONE = "¤Insufficient workers available. If there are idle subjects, these will soon sign up and start working.";
/*  67 */   private final CharSequence ¤¤WORKERS_INSUFFICIENT = "¤Insufficient workers allocated.";
/*  68 */   private final CharSequence ¤¤WORKERS_INSPECT = "¤Inspect";
/*  69 */   private final CharSequence ¤¤AUTO = "¤Auto Employ";
/*  70 */   private final CharSequence ¤¤AUTO_DESC = "¤Let the AI adjust worker amount each day based on workload.";
/*     */   
/*  72 */   private final CharSequence ¤¤mark = "¤Click to apply for {0} subjects";
/*  73 */   private final CharSequence ¤¤unmark = "¤Click to cancel for {0} subjects. ({1} subjects are currently active).";
/*     */   
...
/*  82 */     if (p instanceof RoomBlueprintIns) {
/*  83 */       RoomBlueprintIns<?> pi = (RoomBlueprintIns)p;
/*  84 */       if (pi.employment() != null) {
/*  85 */         l.add(new I(pi));
/*     */       }
/*     */     } 
/*     */   }
...
/*     */ 
/*     */   
/*     */   private CLICKABLE cm(final StatsMultipliers.StatMultiplierAction mm, final GETTER<RoomInstance> get) {
/* 724 */     return (CLICKABLE)new GButt.ButtPanel(mm.icon)
/*     */       {
/*     */         int markable;
/*     */         
/*     */         int active;
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\ModuleEmployment.class
