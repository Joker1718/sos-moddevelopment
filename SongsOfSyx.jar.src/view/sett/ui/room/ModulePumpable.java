...
/*    */ 
/*    */ final class ModulePumpable
/*    */   implements Modules.ModuleMaker {
/* 24 */   private final CharSequence ¤¤Name = "¤Water Supply";
/* 25 */   private final CharSequence ¤¤Desc = "¤Water Supply is gained from adjacent canals and drains that are connected to pumps.";
/* 26 */   private final CharSequence ¤¤Preasure = "¤Pressure required per tile:";
/* 27 */   private final SPRITE icon = (SPRITE)(UI.icons()).s.drop.createColored(COLOR.BLUEISH);
/*    */ 
/*    */   
...
/* 37 */     if (p instanceof RoomPumpable.ROOM_PUMPABLE) {
/* 38 */       l.add(new I((RoomPumpable.ROOM_PUMPABLE)p));
/*    */     }
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\ModulePumpable.class
