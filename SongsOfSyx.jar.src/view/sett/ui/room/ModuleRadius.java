...
/*     */ import util.text.D;
/*     */ 
/*     */ final class ModuleRadius
/*     */   implements Modules.ModuleMaker
/*     */ {
/*  29 */   private final CharSequence ¤¤NAME = "¤Radius";
/*  30 */   private final CharSequence ¤¤PROBLEM = "¤No work is within the radius!";
/*  31 */   private final CharSequence ¤¤DESC = "¤Set the work radius of this room. Subjects will look for work within the radius. A big radius can be ineffective and workers will have a hard time getting back to services when work is done.";
/*     */ 
/*     */   
...
/*  44 */     if (p instanceof ROOM_RADIUS) {
/*  45 */       l.add(new I(p));
/*     */     }
/*     */   }
/*     */ 
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\room\ModuleRadius.class
