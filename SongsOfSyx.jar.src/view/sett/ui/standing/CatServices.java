...
/*     */ import util.text.D;
/*     */ 
/*     */ final class CatServices
/*     */   extends Cats.Cat {
/*  30 */   private static CharSequence ¤¤Other = "¤Other Services";
/*     */   
/*     */   static {
/*  33 */     D.ts(CatServices.class);
/*     */   }
/*     */   
/*     */   CatServices(HCLASS cl, GETTER<Race> race) {
/*  37 */     super(new StatCollection[] { (StatCollection)STATS.SERVICE() });
/*  38 */     StatsService s = STATS.SERVICE();
/*     */     
/*  40 */     titleSet(s.info.name);
/*  41 */     ArrayList<RENDEROBJ> rens = new ArrayList(s.all().size() + 1);
/*     */ 
/*     */ 
/*     */     
/*  45 */     GuiSection sec = new GuiSection();
/*  46 */     sec.add((RENDEROBJ)new GHeader(¤¤Other));
/*  47 */     for (StatServiceImp ss : s.ALL) {
/*     */       
/*  49 */       boolean has = false;
/*  50 */       for (Race r : RACES.all()) {
/*  51 */         if ((ss.total().standing().definition(r).get(cl)).max > 0.0D) {
/*  52 */           has = true;
/*     */           break;
/*     */         } 
/*     */       } 
...
/*     */         continue;
/*     */       }
/*  60 */       rens.add(new StatRowService(ss, cl, race));
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/*  67 */     this.section.add((RENDEROBJ)(new GScrollRows((Iterable)rens, HEIGHT, 0)).view());
/*     */   }
/*     */   
/*     */   private static final class StatRowService
/*     */     extends GuiSection
/*     */   {
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\standing\CatServices.class
