...
/*  37 */   private double last = 0.0D;
/*  38 */   private double now = 0.0D;
/*  39 */   private double max = 0.0D;
/*     */   private final StatCollection[] cs;
/*     */   private final Cats.Cat cat;
/*     */   private final HCLASS cl;
/*     */   private final GETTER<Race> race;
/*     */   
/*     */   CatButt(final Cats cats, Cats.Cat cat, HCLASS cl, GETTER<Race> race, INT.INTE hov) {
/*  46 */     this.cs = cat.cs;
/*  47 */     this.cat = cat;
/*  48 */     this.race = race;
/*     */ 
/*     */     
/*  51 */     hoverInfoSet((this.cs[0]).info.desc);
/*     */ 
/*     */     
/*  54 */     add((RENDEROBJ)new GHeader(cat.title())
/*     */         {
...
/*     */ 
/*     */     
/*  66 */     addDown(2, (RENDEROBJ)new RENDEROBJ.RenderImp(200, 24)
/*     */         {
...
/*     */           }
/*     */         });
/*  76 */     addDown(2, (SPRITE)new GStat()
/*     */         {
/*     */           public void update(GText text)
/*     */           {
/*  80 */             GFORMAT.f(text, CatButt.this.now);
/*  81 */             text.add('/');
/*  82 */             GFORMAT.f(text, CatButt.this.max);
/*  83 */             GFORMAT.colorInterInv(text, CatButt.this.now, CatButt.this.max);
/*     */           }
/*     */         });
/*     */     
/*  87 */     pad(4);
/*     */     
/*  89 */     GStaples staples = new Staples(cl, race, hov, this.cs);
/*  90 */     staples.body().moveX1(228.0D);
/*     */     
/*  92 */     add((RENDEROBJ)staples);
/*  93 */     moveLastToBack();
/*  94 */     pad(4);
/*     */     
/*  96 */     this.cl = cl;
...
/* 101 */     if (this.cl == HCLASSES.CITIZEN()) {
/* 102 */       (VIEW.s()).panels.addDontRemove((VIEW.s()).ui.standing, this.cat);
/*     */     } else {
/* 104 */       (VIEW.s()).panels.addDontRemove((VIEW.s()).ui.slaves, this.cat);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 111 */     this.now = 0.0D;
/* 112 */     this.max = 0.0D;
/* 113 */     this.last = 0.0D; byte b; int i;
/*     */     StatCollection[] arrayOfStatCollection;
/* 115 */     for (i = (arrayOfStatCollection = this.cs).length, b = 0; b < i; ) { StatCollection c = arrayOfStatCollection[b];
/* 116 */       for (STAT s : c.all()) {
/* 117 */         this.now += s.standing().get(this.cl, (Race)this.race.get());
/* 118 */         this.last += s.standing().get(this.cl, (Race)this.race.get(), s.data(this.cl).getPeriodD(this.race.get(), 8, 0));
/* 119 */         this.max += s.standing().max(this.cl, (Race)this.race.get());
/*     */       }  b++; }
/* 121 */      GCOLOR.UI().border().render(r, (RECTANGLE)body());
/* 122 */     GCOLOR.UI().bg(true, (VIEW.s()).panels.added(this.cat), hoveredIs()).render(r, (RECTANGLE)body(), -1);
/*     */ 
/*     */ 
/*     */     
/* 126 */     super.render(r, ds);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 133 */     b.title(this.cat.name);
/* 134 */     b.text(this.cat.desc);
/* 135 */     b.NL();
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\view\set\\ui\standing\CatButt.class
