...
/* 958 */   private static ArrayList<String> getLinuxLdPaths() { ArrayList<String> ldPaths = new ArrayList<String>();
/*     */     try {
/* 960 */       Process process = Runtime.getRuntime().exec("/sbin/ldconfig -p");
/* 961 */       BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()));
/* 962 */       String buffer = "";
/* 963 */       while ((buffer = reader.readLine()) != null) {
/* 964 */         int startPath = buffer.indexOf(" => ");
/* 965 */         int endPath = buffer.lastIndexOf('/');
/* 966 */         if (startPath != -1 && endPath != -1 && startPath < endPath) {
/* 967 */           String path = buffer.substring(startPath + 4, endPath);
/* 968 */           if (!ldPaths.contains(path)) {
/* 969 */             ldPaths.add(path);
/*     */           }
/*     */         } 
/*     */       } 
/* 973 */       reader.close();
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\com\sun\jna\NativeLibrary.class
