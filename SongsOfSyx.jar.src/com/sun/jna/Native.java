...
/*      */     
/*  192 */     if (!isCompatibleVersion("5.1.0", getNativeVersion())) {
/*  193 */       String LS = System.getProperty("line.separator");
/*  194 */       throw new Error(LS + LS + "There is an incompatible JNA native library installed on this system" + LS + "Expected: " + "5.1.0" + LS + "Found:    " + 
/*      */ 
/*      */           
...
/*  221 */     Platform.isLinux() && (Platform.isARM() || Platform.isPPC())) || 
/*  222 */     Platform.isAIX() || 
...
/* 1539 */     if (type == Boolean.class) { type = boolean.class; }
/* 1540 */     else if (type == Byte.class) { type = byte.class; }
/* 1541 */     else if (type == Short.class) { type = short.class; }
/* 1542 */     else if (type == Character.class) { type = char.class; }
/* 1543 */     else if (type == Integer.class) { type = int.class; }
/* 1544 */     else if (type == Long.class) { type = long.class; }
/* 1545 */     else if (type == Float.class) { type = float.class; }
/* 1546 */     else if (type == Double.class) { type = double.class; }
/* 1547 */     else if (type == Void.class) { type = void.class; }
/*      */     
/* 1549 */     if (mapper != null) {
/* 1550 */       FromNativeConverter fromNative = mapper.getFromNativeConverter(type);
/* 1551 */       ToNativeConverter toNative = mapper.getToNativeConverter(type);
/* 1552 */       if (fromNative != null) {
/* 1553 */         Class<?> nativeType = fromNative.nativeType();
/* 1554 */         if (nativeType == String.class) {
/* 1555 */           return 24;
/*      */         }
/* 1557 */         if (nativeType == WString.class) {
/* 1558 */           return 25;
/*      */         }
/* 1560 */         return 23;
/*      */       } 
/* 1562 */       if (toNative != null) {
/* 1563 */         Class<?> nativeType = toNative.nativeType();
/* 1564 */         if (nativeType == String.class) {
/* 1565 */           return 24;
/*      */         }
/* 1567 */         if (nativeType == WString.class) {
/* 1568 */           return 25;
/*      */         }
/* 1570 */         return 23;
/*      */       } 
/*      */     } 
/*      */     
/* 1574 */     if (Pointer.class.isAssignableFrom(type)) {
/* 1575 */       return 1;
/*      */     }
/* 1577 */     if (String.class == type) {
/* 1578 */       return 2;
/*      */     }
/* 1580 */     if (WString.class.isAssignableFrom(type)) {
/* 1581 */       return 20;
/*      */     }
/* 1583 */     if (Platform.HAS_BUFFERS && Buffers.isBuffer(type)) {
/* 1584 */       return 5;
/*      */     }
/* 1586 */     if (Structure.class.isAssignableFrom(type)) {
/* 1587 */       if (Structure.ByValue.class.isAssignableFrom(type)) {
/* 1588 */         return 4;
/*      */       }
/* 1590 */       return 3;
/*      */     } 
/* 1592 */     if (type.isArray()) {
/* 1593 */       switch (type.getName().charAt(1)) { case 'Z':
/* 1594 */           return 13;
/* 1595 */         case 'B': return 6;
/* 1596 */         case 'S': return 7;
/* 1597 */         case 'C': return 8;
/* 1598 */         case 'I': return 9;
/* 1599 */         case 'J': return 10;
/* 1600 */         case 'F': return 11;
/* 1601 */         case 'D': return 12; }
/*      */ 
/*      */     
/*      */     }
/* 1605 */     if (type.isPrimitive()) {
/* 1606 */       return (type == boolean.class) ? 14 : 0;
/*      */     }
/* 1608 */     if (Callback.class.isAssignableFrom(type)) {
/* 1609 */       return 15;
/*      */     }
/* 1611 */     if (IntegerType.class.isAssignableFrom(type)) {
/* 1612 */       return 21;
/*      */     }
/* 1614 */     if (PointerType.class.isAssignableFrom(type)) {
/* 1615 */       return 22;
/*      */     }
/* 1617 */     if (NativeMapped.class.isAssignableFrom(type)) {
/* 1618 */       Class<?> nativeType = NativeMappedConverter.getInstance(type).nativeType();
/* 1619 */       if (nativeType == String.class) {
/* 1620 */         return 18;
/*      */       }
/* 1622 */       if (nativeType == WString.class) {
/* 1623 */         return 19;
/*      */       }
/* 1625 */       return 17;
/*      */     } 
...
/* 1642 */     NativeLibrary library = NativeLibrary.getInstance(libName, Collections.singletonMap("classloader", cls.getClassLoader()));
/* 1643 */     register(cls, library);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1656 */     Method[] methods = cls.getDeclaredMethods();
/* 1657 */     List<Method> mlist = new ArrayList<Method>();
/* 1658 */     Map<String, ?> options = lib.getOptions();
/* 1659 */     TypeMapper mapper = (TypeMapper)options.get("type-mapper");
/* 1660 */     options = cacheOptions(cls, options, null);
/*      */     
/* 1662 */     for (Method m : methods) {
/* 1663 */       if ((m.getModifiers() & 0x100) != 0) {
/* 1664 */         mlist.add(m);
/*      */       }
/*      */     } 
/*      */     
/* 1668 */     long[] handles = new long[mlist.size()];
/* 1669 */     for (int i = 0; i < handles.length; i++) {
/* 1670 */       long rtype, closure_rtype; Method method = mlist.get(i);
/* 1671 */       String sig = "(";
/* 1672 */       Class<?> rclass = method.getReturnType();
/*      */       
/* 1674 */       Class<?>[] ptypes = method.getParameterTypes();
/* 1675 */       long[] atypes = new long[ptypes.length];
/* 1676 */       long[] closure_atypes = new long[ptypes.length];
/* 1677 */       int[] cvt = new int[ptypes.length];
/* 1678 */       ToNativeConverter[] toNative = new ToNativeConverter[ptypes.length];
/* 1679 */       FromNativeConverter fromNative = null;
/* 1680 */       int rcvt = getConversion(rclass, mapper);
/* 1681 */       boolean throwLastError = false;
/* 1682 */       switch (rcvt) {
/*      */         case -1:
/* 1684 */           throw new IllegalArgumentException(rclass + " is not a supported return type (in method " + method.getName() + " in " + cls + ")");
/*      */         case 23:
/*      */         case 24:
/*      */         case 25:
/* 1688 */           fromNative = mapper.getFromNativeConverter(rclass);
/*      */ 
/*      */ 
/*      */           
/* 1692 */           closure_rtype = (Structure.FFIType.get(rclass.isPrimitive() ? rclass : Pointer.class)).peer;
/* 1693 */           rtype = (Structure.FFIType.get(fromNative.nativeType())).peer;
/*      */           break;
/*      */         case 17:
/*      */         case 18:
/*      */         case 19:
/*      */         case 21:
/*      */         case 22:
/* 1700 */           closure_rtype = (Structure.FFIType.get(Pointer.class)).peer;
/* 1701 */           rtype = (Structure.FFIType.get(NativeMappedConverter.getInstance(rclass).nativeType())).peer;
/*      */           break;
/*      */         case 3:
/* 1704 */           closure_rtype = rtype = (Structure.FFIType.get(Pointer.class)).peer;
/*      */         
/*      */         case 4:
/* 1707 */           closure_rtype = (Structure.FFIType.get(Pointer.class)).peer;
/* 1708 */           rtype = (Structure.FFIType.get(rclass)).peer;
/*      */           break;
/*      */         default:
/* 1711 */           closure_rtype = rtype = (Structure.FFIType.get(rclass)).peer;
/*      */           break;
/*      */       } 
/* 1714 */       for (int t = 0; t < ptypes.length; t++) {
/* 1715 */         Class<?> type = ptypes[t];
/* 1716 */         sig = sig + getSignature(type);
/* 1717 */         int conversionType = getConversion(type, mapper);
/* 1718 */         cvt[t] = conversionType;
/* 1719 */         if (conversionType == -1) {
/* 1720 */           throw new IllegalArgumentException(type + " is not a supported argument type (in method " + method.getName() + " in " + cls + ")");
/*      */         }
/* 1722 */         if (conversionType == 17 || conversionType == 18 || conversionType == 19 || conversionType == 21) {
/*      */ 
/*      */ 
/*      */           
/* 1726 */           type = NativeMappedConverter.getInstance(type).nativeType();
/* 1727 */         } else if (conversionType == 23 || conversionType == 24 || conversionType == 25) {
/*      */ 
/*      */           
/* 1730 */           toNative[t] = mapper.getToNativeConverter(type);
/*      */         } 
/*      */ 
/*      */ 
/*      */ 
/*      */         
/* 1736 */         switch (conversionType) {
/*      */           case 4:
/*      */           case 17:
/*      */           case 18:
/*      */           case 19:
/*      */           case 21:
/*      */           case 22:
/* 1743 */             atypes[t] = (Structure.FFIType.get(type)).peer;
/* 1744 */             closure_atypes[t] = (Structure.FFIType.get(Pointer.class)).peer;
/*      */             break;
/*      */           case 23:
/*      */           case 24:
/*      */           case 25:
/* 1749 */             closure_atypes[t] = (Structure.FFIType.get(type.isPrimitive() ? type : Pointer.class)).peer;
/* 1750 */             atypes[t] = (Structure.FFIType.get(toNative[t].nativeType())).peer;
/*      */             break;
/*      */           case 0:
/* 1753 */             atypes[t] = (Structure.FFIType.get(type)).peer; closure_atypes[t] = (Structure.FFIType.get(type)).peer;
/*      */           
/*      */           default:
/* 1756 */             atypes[t] = (Structure.FFIType.get(Pointer.class)).peer; closure_atypes[t] = (Structure.FFIType.get(Pointer.class)).peer; break;
/*      */         } 
/*      */       } 
/* 1759 */       sig = sig + ")";
/* 1760 */       sig = sig + getSignature(rclass);
/*      */       
/* 1762 */       Class<?>[] etypes = method.getExceptionTypes();
/* 1763 */       for (int e = 0; e < etypes.length; e++) {
/* 1764 */         if (LastErrorException.class.isAssignableFrom(etypes[e])) {
/* 1765 */           throwLastError = true;
/*      */           
/*      */           break;
/*      */         } 
/*      */       } 
/* 1770 */       Function f = lib.getFunction(method.getName(), method);
/*      */       try {
/* 1772 */         handles[i] = registerMethod(cls, method.getName(), sig, cvt, closure_atypes, atypes, rcvt, closure_rtype, rtype, method, f.peer, f
/*      */ 
/*      */ 
/*      */ 
/*      */             
/* 1777 */             .getCallingConvention(), throwLastError, toNative, fromNative, f.encoding);
/*      */ 
/*      */       
/*      */       }
/* 1781 */       catch (NoSuchMethodError noSuchMethodError) {
/* 1782 */         throw new UnsatisfiedLinkError("No method " + method.getName() + " with signature " + sig + " in " + cls);
/*      */       } 
/*      */     } 
/* 1785 */     synchronized (registeredClasses) {
/* 1786 */       registeredClasses.put(cls, handles);
/* 1787 */       registeredLibraries.put(cls, lib);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1796 */     libOptions.put("enclosing-library", cls);
/* 1797 */     synchronized (libraries) {
/* 1798 */       typeOptions.put(cls, libOptions);
/* 1799 */       if (proxy != null) {
/* 1800 */         libraries.put(cls, new WeakReference(proxy));
/*      */       }
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1806 */       if (!cls.isInterface() && Library.class
/* 1807 */         .isAssignableFrom(cls)) {
/* 1808 */         Class<?>[] ifaces = cls.getInterfaces();
/* 1809 */         for (Class<?> ifc : ifaces) {
/* 1810 */           if (Library.class.isAssignableFrom(ifc)) {
/* 1811 */             cacheOptions(ifc, libOptions, proxy);
/*      */             break;
/*      */           } 
/*      */         } 
/*      */       } 
/*      */     } 
/* 1817 */     return libOptions;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1841 */     return (NativeMapped)NativeMappedConverter.getInstance(cls).fromNative(value, new FromNativeContext(cls));
/*      */   }
/*      */   
/*      */   private static NativeMapped fromNative(Method m, Object value) {
/* 1845 */     Class<?> cls = m.getReturnType();
/* 1846 */     return (NativeMapped)NativeMappedConverter.getInstance(cls).fromNative(value, new MethodResultContext(cls, null, null, m));
/*      */   }
/*      */   
/*      */   private static Class<?> nativeType(Class<?> cls) {
/* 1850 */     return NativeMappedConverter.getInstance(cls).nativeType();
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private static Object toNative(ToNativeConverter cvt, Object o) {
/* 1856 */     return cvt.toNative(o, new ToNativeContext());
/*      */   }
/*      */   
/*      */   private static Object fromNative(FromNativeConverter cvt, Object o, Method m) {
/* 1860 */     return cvt.fromNative(o, new MethodResultContext(m.getReturnType(), null, null, m));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1879 */     String DEFAULT_TITLE = "Java Native Access (JNA)";
/* 1880 */     String DEFAULT_VERSION = "4.4.0";
/* 1881 */     String DEFAULT_BUILD = "4.4.0 (package information missing)";
/* 1882 */     Package pkg = Native.class.getPackage();
/*      */     
/* 1884 */     String title = (pkg != null) ? pkg.getSpecificationTitle() : "Java Native Access (JNA)";
/* 1885 */     if (title == null) title = "Java Native Access (JNA)";
/*      */     
/* 1887 */     String version = (pkg != null) ? pkg.getSpecificationVersion() : "4.4.0";
/* 1888 */     if (version == null) version = "4.4.0"; 
/* 1889 */     title = title + " API Version " + version;
/* 1890 */     System.out.println(title);
/*      */     
/* 1892 */     version = (pkg != null) ? pkg.getImplementationVersion() : "4.4.0 (package information missing)";
/* 1893 */     if (version == null) version = "4.4.0 (package information missing)"; 
/* 1894 */     System.out.println("Version: " + version);
/* 1895 */     System.out.println(" Native: " + getNativeVersion() + " (" + 
/* 1896 */         getAPIChecksum() + ")");
/* 1897 */     System.out.println(" Prefix: " + Platform.RESOURCE_PREFIX);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2022 */     invokeStructure(function, fp, callFlags, args, (s.getPointer()).peer, 
/* 2023 */         (s.getTypeInfo()).peer);
/* 2024 */     return s;
/*      */   }
/*      */ 
/*      */ 
...
/* 2131 */     long peer = _getPointer(addr);
/* 2132 */     return (peer == 0L) ? null : new Pointer(peer);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2140 */     return getString(pointer, offset, getDefaultStringEncoding());
/*      */   }
/*      */   
/*      */   static String getString(Pointer pointer, long offset, String encoding) {
/* 2144 */     byte[] data = getStringBytes(pointer, pointer.peer, offset);
/* 2145 */     if (encoding != null) {
/*      */       try {
/* 2147 */         return new String(data, encoding);
/*      */       }
/* 2149 */       catch (UnsupportedEncodingException unsupportedEncodingException) {}
/*      */     }
/*      */     
/* 2152 */     return new String(data);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 2206 */   private static final ThreadLocal<Memory> nativeThreadTerminationFlag = new ThreadLocal<Memory>()
/*      */     {
/*      */       protected Memory initialValue()
/*      */       {
/* 2210 */         Memory m = new Memory(4L);
/* 2211 */         m.clear();
/* 2212 */         return m;
/*      */       }
/*      */     };
/* 2215 */   private static final Map<Thread, Pointer> nativeThreads = Collections.synchronizedMap(new WeakHashMap<Thread, Pointer>()); private static native void initIDs(); public static synchronized native void setProtected(boolean paramBoolean); public static synchronized native boolean isProtected(); static native long getWindowHandle0(Component paramComponent); private static native long _getDirectBufferPointer(Buffer paramBuffer); private static native int sizeof(int paramInt);
...
/* 2229 */     Thread thread = Thread.currentThread();
/* 2230 */     if (detach) {
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 2237 */       nativeThreads.remove(thread);
/* 2238 */       Pointer p = nativeThreadTerminationFlag.get();
/* 2239 */       setDetachState(true, 0L);
/*      */     
/*      */     }
/* 2242 */     else if (!nativeThreads.containsKey(thread)) {
/* 2243 */       Pointer p = nativeThreadTerminationFlag.get();
/* 2244 */       nativeThreads.put(thread, p);
/* 2245 */       setDetachState(false, p.peer);
/*      */     } 
...
/* 2251 */     return nativeThreads.get(t);
...
/* 2258 */       return Buffer.class.isAssignableFrom(cls);
/*      */     } }
/*      */ 
/*      */ 
/*      */ 
...
/* 2267 */       return getComponentID(w);
/*      */     }
/*      */ 
/*      */     
/*      */     static long getComponentID(Object o) throws HeadlessException {
/* 2272 */       if (GraphicsEnvironment.isHeadless()) {
/* 2273 */         throw new HeadlessException("No native windows when headless");
/*      */       }
/* 2275 */       Component c = (Component)o;
/* 2276 */       if (c.isLightweight()) {
/* 2277 */         throw new IllegalArgumentException("Component must be heavyweight");
/*      */       }
/* 2279 */       if (!c.isDisplayable()) {
/* 2280 */         throw new IllegalStateException("Component must be displayable");
/*      */       }
/* 2282 */       if (Platform.isX11() && 
/* 2283 */         System.getProperty("java.version").startsWith("1.4") && 
/* 2284 */         !c.isVisible()) {
/* 2285 */         throw new IllegalStateException("Component must be visible");
/*      */       }
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 2291 */       return Native.getWindowHandle0(c);
/*      */     }
/*      */   }
/*      */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\com\sun\jna\Native.class
