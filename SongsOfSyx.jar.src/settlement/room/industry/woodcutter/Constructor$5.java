...
/* 113 */     Room r = (SETT.ROOMS()).map.get(it.tile());
/* 114 */     if (r != null && r instanceof Instance)
/* 115 */       (((Instance)r).blueprintI()).job.storage.render(ren, shadowBatch, it.tx(), it.ty(), it.x(), it.y(), it.ran()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\room\industry\woodcutter\Constructor$5.class
