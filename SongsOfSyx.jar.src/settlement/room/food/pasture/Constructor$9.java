...
/* 187 */     for (int i = 0; i < DIR.ALL.size(); i++) {
/* 188 */       if (!roomIs.is(tx, ty, (DIR)DIR.ALL.get(i)))
/* 189 */         return Dic.empty; 
/*     */     } 
/* 191 */     return super.isPlacable(tx, ty, roomIs, it, rx, ry);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\room\food\pasture\Constructor$9.class
