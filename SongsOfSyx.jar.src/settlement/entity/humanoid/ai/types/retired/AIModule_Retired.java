...
/*     */ import util.text.D;
/*     */ 
/*     */ public final class AIModule_Retired
/*     */   extends AIModule {
/*  26 */   private final Plan plan = new Plan(this);
/*     */   
/*  28 */   private static CharSequence ¤¤name = "Retire";
/*  29 */   private static CharSequence ¤¤desc = "Spend time at a retirement facility.";
/*     */   static {
/*  31 */     D.ts(AIModule_Retired.class);
/*     */   }
/*     */ 
/*     */   
/*     */   public AIModule_Retired() {
/*  36 */     super((SPRITE)(UI.icons()).s.clock, ¤¤name, ¤¤desc);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  43 */     for (ROOM_RESTHOME h : (a.race().pref()).resthomes) {
/*  44 */       if (h.emp.employ(a)) {
/*  45 */         (AI.modules()).work.swapInstance(a);
/*  46 */         return this.plan.activate(a, d);
/*     */       } 
/*     */     } 
/*     */     
/*  50 */     return null;
...
/*  55 */     for (ROOM_RESTHOME h : (a.race().pref()).resthomes) {
/*  56 */       if (h.emp.employ(a)) {
/*     */         return;
/*     */       }
/*     */     } 
/*     */   }
...
/*  65 */     if ((STATS.WORK()).EMPLOYED.get(a) == null) {
/*  66 */       for (ROOM_RESTHOME h : (a.race().pref()).resthomes) {
/*  67 */         if (h.emp.employable() > 0)
/*  68 */           return 4; 
/*     */       } 
/*  70 */       return 0;
/*     */     } 
/*     */     
/*  73 */     return ((STATS.WORK()).WORK_TIME.indu().getD(a.indu()) < 1.0D) ? 4 : 0;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\types\retired\AIModule_Retired.class
