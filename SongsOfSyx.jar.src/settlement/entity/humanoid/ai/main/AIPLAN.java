...
/*     */ {
/*  17 */   private static final AiPlanActivation activation = new AiPlanActivation();
/*     */   
/*     */   private AIPLAN(String key) {
/*  20 */     super("PLAN_" + key);
/*     */   }
/*     */   public abstract AiPlanActivation activate(Humanoid paramHumanoid, AIManager paramAIManager);
/*     */   
/*     */   abstract void cancel(Humanoid paramHumanoid, AIManager paramAIManager);
/*     */   
/*     */   public static class AiPlanActivation { private AIPLAN plan;
/*     */     
/*     */     AIPLAN plan() {
...
/*     */ 
/*     */   
/*     */   abstract AISUB.AISubActivation resume(Humanoid paramHumanoid, AIManager paramAIManager);
/*     */ 
/*     */   
/*     */   abstract boolean shouldContinue(Humanoid paramHumanoid, AIManager paramAIManager);
/*     */ 
/*     */   
/*     */   abstract void name(Humanoid paramHumanoid, AIManager paramAIManager, Str paramStr);
/*     */   
/*     */   abstract AISUB.AISubActivation resumeFailed(Humanoid paramHumanoid, AIManager paramAIManager, HEvent paramHEvent);
/*     */   
...
/*  61 */     return d.plansub().event(a, d, e);
/*     */   }
/*     */ 
/*     */   
/*     */   public double poll(Humanoid a, AIManager d, HPoll.HPollData e) {
/*  66 */     return d.plansub().poll(a, d, e);
/*     */   }
/*     */   
/*  69 */   private static String empty = "";
/*     */   protected String debug(Humanoid a, AIManager d) {
/*  71 */     return empty;
/*     */   }
/*     */   
/*     */   protected static AISUB.AISubActivation trySub(Humanoid a, AIManager d, AISUB.AISubActivation trial, AIData.AIDataSuspender suspender) {
/*  75 */     if (trial == null) {
/*  76 */       if (suspender != null)
/*  77 */         suspender.suspend(d); 
/*  78 */       return (AI.SUBS()).failure.activate(a, d);
/*     */     } 
/*  80 */     return trial;
/*     */   }
/*     */   
/*     */   public static abstract class PLANRES
/*     */     extends AIPLAN {
...
/*     */     }
/*     */     
/*     */     protected abstract AISUB.AISubActivation init(Humanoid param1Humanoid, AIManager param1AIManager);
/*     */     
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\main\AIPLAN.class
