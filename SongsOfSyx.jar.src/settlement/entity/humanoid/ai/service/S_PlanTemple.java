...
/*     */   S_PlanTemple() {
/*  26 */     super((StatService)(STATS.RELIGION()).TEMPLE, 0.125D);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  62 */     this.aa = new Bitmap1D(100000, false);
/*     */     
/*  64 */     this.plan = (AIPLAN)new AIPLAN.PLANRES("ser_temple")
/*     */       {
/*     */         protected AISUB.AISubActivation init(Humanoid a, AIManager d)
/*     */         {
/*  68 */           return this.walk.set(a, d);
/*     */         }
/*     */         
/*  71 */         private final AIPLAN.PLANRES.Resumer walk = new AIPLAN.PLANRES.Resumer(this, null)
/*     */           {
...
/*     */           };
/*     */         
/* 111 */         private final AIPLAN.PLANRES.Resumer pray = new AIPLAN.PLANRES.Resumer(this, null)
/*     */           {
/*     */             protected AISUB.AISubActivation setAction(Humanoid a, AIManager d)
/*     */             {
...
/*     */           };
/*     */         
/* 170 */         private final AIPLAN.PLANRES.Resumer next = new AIPLAN.PLANRES.Resumer(this, null)
/*     */           {
/*     */             protected AISUB.AISubActivation setAction(Humanoid a, AIManager d)
/*     */             {
...
/*     */     return ((StatsReligion.StatReligion)(STATS.RELIGION()).getter.get(a.indu())).permissionTemple.has(a);
/*     */   }
/*     */   
...
/*     */     AIPLAN.AiPlanActivation pp = this.plan.activate(a, d);
/*     */     if (pp == null)
...
/*     */     return (SETT.ROOMS()).TEMPLES.temples(((StatsReligion.StatReligion)(STATS.RELIGION()).getter.get(a.indu())).religion);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\service\S_PlanTemple.class
