...
/*     */   extends S_Plan
/*     */ {
/*  24 */   private static CharSequence ¤¤verb = "¤Skinny dipping";
/*     */   
/*     */   static {
/*  27 */     D.ts(PlanSkinny.class);
/*     */   }
/*     */   
/*  30 */   private final StatServiceSimple stat = (STATS.SERVICE()).skinnyDip;
/*     */   
/*     */   public PlanSkinny() {
/*  33 */     super((StatService)(STATS.SERVICE()).skinnyDip, 1.0D);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  68 */     this.skinnydip = (AIPLAN)new AIPLAN.PLANRES("ser" + this.stat.total().key())
/*     */       {
/*     */         protected AISUB.AISubActivation init(Humanoid a, AIManager d)
/*     */         {
/*  72 */           if ((SETT.WEATHER()).ice.canBatheOutside() && (SETT.PATH()).finders.water.has(a.tc())) {
/*  73 */             return this.walkToWater.set(a, d);
/*     */           }
/*  75 */           return null;
/*     */         }
/*     */         
/*  78 */         private final AISUB sub = (AISUB)new AISUB.Simple("")
/*     */           {
/*     */             
...
/*     */           };
/*     */         
/* 117 */         private final AIPLAN.PLANRES.Resumer walkToWater = new AIPLAN.PLANRES.Resumer(this, PlanSkinny.¤¤verb)
/*     */           {
/*     */             
...
/*     */           };
/*     */         
/* 163 */         private final AIPLAN.PLANRES.Resumer bathe = new AIPLAN.PLANRES.Resumer(this, PlanSkinny.¤¤verb)
/*     */           {
/*     */             protected AISUB.AISubActivation setAction(Humanoid a, AIManager d)
/*     */             {
...
/*     */   
/*     */   private int dist;
/*     */   public final AIPLAN skinnydip;
/*     */   
/*     */   public boolean hasAccess(Humanoid a, AIManager d) {
/*     */     return this.stat.access(a);
/*     */   }
/*     */   
/*     */   public boolean allowed(Humanoid a, AIManager d) {
/*     */     return this.stat.permission().is(a.indu().popCL());
/*     */   }
/*     */   
...
/*     */     this.dist = 128;
/*     */     return this.skinnydip.activate(a, d);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\service\PlanSkinny.class
