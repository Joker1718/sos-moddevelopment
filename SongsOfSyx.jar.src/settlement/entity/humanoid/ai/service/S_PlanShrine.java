...
/*     */   S_PlanShrine() {
/*  25 */     super((StatService)(STATS.RELIGION()).SHRINE, 1.0D);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  61 */     this.plan = (AIPLAN)new AIPLAN.PLANRES("serShrine")
/*     */       {
/*     */         protected AISUB.AISubActivation init(Humanoid a, AIManager d)
/*     */         {
/*  65 */           return this.walk.set(a, d);
/*     */         }
/*     */         
/*  68 */         private final AIPLAN.PLANRES.Resumer walk = new AIPLAN.PLANRES.Resumer(this, null)
/*     */           {
...
/*     */           };
/*     */         
/* 107 */         private final AIPLAN.PLANRES.Resumer pray = new AIPLAN.PLANRES.Resumer(this, null)
/*     */           {
/*     */             protected AISUB.AISubActivation setAction(Humanoid a, AIManager d)
/*     */             {
...
/*     */     return ((StatsReligion.StatReligion)(STATS.RELIGION()).getter.get(a.indu())).permissionShrine.has(a);
/*     */   }
/*     */   
...
/*     */     AIPLAN.AiPlanActivation p = this.plan.activate(a, d);
/*     */     if (p == null)
...
/*     */     return (SETT.ROOMS()).TEMPLES.shrines(((StatsReligion.StatReligion)(STATS.RELIGION()).getter.get(a.indu())).religion);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\service\S_PlanShrine.class
