...
/*    */   protected WorkFisherman(AIModule_Work module, ROOM_FISHERY blueprint, PlanBlueprint[] map, WorkAbs.Works works) {
/* 18 */     super(module, (RoomBlueprintIns<?>)blueprint, map, works);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/*    */     
/* 34 */     this.goFishing = new AIPLAN.PLANRES.Resumer(this, "fishyfish")
/*    */       {
...
/* 63 */           WorkFisherman.this.work.can(a, d);
...
/*    */   }
/*    */   
/*    */   final AIPLAN.PLANRES.Resumer goFishing;
/*    */   
/*    */   protected AISUB.AISubActivation work(Humanoid a, AIManager d) {
/*    */     ROOM_FISHERY f = (ROOM_FISHERY)work(a).blueprintI();
/*    */     if (f.launchFishingExpedition(a, d.planTile.x(), d.planTile.y()))
/*    */       return this.goFishing.set(a, d); 
/*    */     return super.work(a, d);
/*    */   }
/*    */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\entity\humanoid\ai\work\WorkFisherman.class
