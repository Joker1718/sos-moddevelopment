...
/*  34 */     D.t(this);
/*  35 */     this.info = new INFO(
/*  36 */         D.g("Trait"), 
/*  37 */         D.g("Traits"), 
/*  38 */         D.g("TraitDesc", "Traits can manifest themselves in individual subjects and in turn change properties of said person."), null);
/*     */ 
/*     */     
/*  41 */     this.all = new ArrayList(TRAITS.ALL().size());
/*     */     
/*  43 */     for (TRAIT t : TRAITS.ALL());
/*     */ 
/*     */ 
/*     */     
/*  47 */     init.onConstruct.add(new StatsInit.StatInitable()
/*     */         {
...
/*  59 */     return (LIST<StatTrait>)this.all;
/*     */   }
/*     */   
/*     */   public StatTrait stat(TRAIT t) {
/*  63 */     return (StatTrait)this.all.get(t.index());
/*     */   }
/*     */   
/*     */   public static final class StatTrait
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\stats\colls\StatsTraits.class
