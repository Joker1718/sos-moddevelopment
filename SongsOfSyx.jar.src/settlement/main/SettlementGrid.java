...
/*     */ {
/*  22 */   public static int TILES = 3;
/*     */ 
/*     */ 
/*     */   
/*  26 */   public static int QUAD_SIZE = SETT.TWIDTH / TILES;
/*  27 */   public static int QUAD_AREA = QUAD_SIZE * QUAD_SIZE;
/*  28 */   public static int QUAD_HALF = QUAD_SIZE / 2;
/*  29 */   public static int QUAD_QUATER = QUAD_HALF / 2;
/*  30 */   public static int QUAD_EIGHTH = QUAD_QUATER / 2;
/*     */   
/*  32 */   private final RECTANGLE[][] bounds = new RECTANGLE[TILES][TILES];
/*  33 */   private final ArrayList<Tile> tiles = new ArrayList(TILES * TILES);
/*     */ 
/*     */   
/*     */   SettlementGrid() {
/*  37 */     final STRING_RECIEVER reciever = new STRING_RECIEVER()
/*     */       {
...
/*     */ 
/*     */     
/*  45 */     ACTION a = new ACTION()
/*     */       {
/*     */         public void exe()
/*     */         {
/*  49 */           (VIEW.inters()).input.requestInput(reciever, "type something");
/*     */         }
/*     */       };
/*     */     
/*  53 */     IDebugPanelSett.add("prort", a);
/*     */     
/*  55 */     for (int y = 0; y < TILES; y++) {
/*  56 */       for (int x = 0; x < TILES; x++) {
/*  57 */         this.bounds[y][x] = (RECTANGLE)new Rec((x * QUAD_SIZE), (x * QUAD_SIZE + QUAD_SIZE), (y * QUAD_SIZE), (
/*  58 */             y * QUAD_SIZE + QUAD_SIZE));
/*  59 */         this.tiles.add(new Tile(x, y));
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 134 */     return (Tile)this.tiles.get(tile);
/*     */   }
/*     */   
/*     */   public Tile tile(int x, int y) {
/* 138 */     return (Tile)this.tiles.get(x + y * TILES);
/*     */   }
/*     */   
/*     */   public LIST<Tile> tiles() {
/* 142 */     return (LIST<Tile>)this.tiles;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\settlement\main\SettlementGrid.class
