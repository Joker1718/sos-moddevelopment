...
/*  23 */   public double lat = 0.5D;
/*  24 */   public String map = null;
/*  25 */   public int seed = RND.seed();
/*     */   public int playerX;
/*     */   public int playerY;
/*     */   
...
/*  35 */     file.bool(this.hasGeneratedTerrain);
/*  36 */     file.bool(this.isEditing);
/*  37 */     file.d(this.lat);
/*  38 */     if (this.map != null) {
/*  39 */       file.bool(true);
/*  40 */       file.chars(this.map);
/*     */     } else {
/*  42 */       file.bool(false);
/*     */     } 
/*  44 */     file.i(this.seed);
/*  45 */     file.i(this.playerX);
/*  46 */     file.i(this.playerY);
/*  47 */     file.bool(this.isDone);
/*     */   }
/*     */ 
/*     */   
/*     */   public void load(FileGetter file) throws IOException {
/*  52 */     this.hasGeneratedTerrain = file.bool();
/*  53 */     this.isEditing = file.bool();
/*  54 */     this.lat = file.d();
/*  55 */     if (file.bool()) {
/*  56 */       this.map = file.chars();
/*     */     } else {
/*  58 */       this.map = null;
/*  59 */     }  this.seed = file.i();
/*  60 */     this.playerX = file.i();
/*  61 */     this.playerY = file.i();
/*  62 */     this.isDone = file.bool();
/*     */   }
/*     */ 
/*     */   
/*     */   public void clear() {
/*  67 */     this.hasGeneratedTerrain = false;
/*  68 */     this.lat = 0.5D;
/*  69 */     this.map = null;
/*  70 */     this.seed = RND.rInt(2147483647);
/*  71 */     this.playerX = -1;
/*  72 */     this.playerY = -1;
/*  73 */     this.isDone = false;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\world\WorldGen.class
