...
/* 684 */     return this.iconSprite;
/*     */   }
/*     */   
/*     */   boolean coversCompleatly(int tile) {
/*     */     return (WorldWater.this.dataGet(tile) == 15);
/*     */   }
/*     */   
...
/*     */       if (!WORLD.IN_BOUNDS(tx, ty, d) || is(tx, ty, d)) {
/*     */         res |= d.mask();
/*     */       } else if (WorldWater.this.LAKE.delta.is(tx, ty, d) || WorldWater.this.OCEAN.delta.is(tx, ty, d)) {
/*     */         int x = tx + d.x() * 2;
/*     */         int y = ty + d.y() * 2;
/*     */         if (WorldWater.this.OCEAN.normal.is(x, y) || WorldWater.this.LAKE.normal.is(x, y))
/*     */           res |= d.mask(); 
/*     */       } 
/*     */     } 
/*     */     if (res == 15) {
/*     */       WORLD.MOUNTAIN().pClear(tx, ty);
/*     */       (WORLD.FOREST()).amount.set(tx, ty, 0.0D);
/*     */     } 
/*     */     WorldWater.this.dataSet(tx, ty, res);
/*     */   }
/*     */   
/*     */   boolean render(SPRITE_RENDERER r, int data, RenderData.RenderIterator it) {
/*     */     WorldWater.this.LAKE.col.bind();
/*     */     WorldWater.this.sprites.riverFG.render(r, data + (it.ran() & 0x7) * 16, it.x(), it.y());
/*     */     WorldWater.this.sprites.renderTexture(it);
/*     */     return false;
/*     */   }
/*     */   
/*     */   boolean renderShore(SPRITE_RENDERER r, int data, RenderData.RenderIterator it) {
/*     */     WorldWater.this.LAKE.cShore.bind();
/*     */     WorldWater.this.sprites.riverBG.render(r, data + (it.ran() & 0x7) * 16, it.x(), it.y());
/*     */     return false;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\world\map\terrain\WorldWater$River.class
