...
/*     */         res |= d.mask();
/*     */       } else if (WorldWater.this.get(tx, ty, d) != WorldWater.this.NOTHING) {
/*     */         res |= d.mask();
/*     */         if (!is(tx, ty, d))
/*     */           other |= d.mask(); 
/*     */       } 
/*     */     } 
/*     */     WorldWater.this.dataSet(tx, ty, res | other << 4);
/*     */   }
/*     */   
...
/*     */     int o = data >>> 4;
/*     */     data &= 0xF;
/*     */     WorldWater.this.sprites.riverSmallBG.render(r, data + (it.ran() & 0x7) * 16, it.x(), it.y());
/*     */     if (o != 0)
/*     */       for (int i = 0; i < DIR.ORTHO.size(); i++) {
/*     */         DIR d = (DIR)DIR.ORTHO.get(i);
/*     */         if ((d.mask() & o) != 0) {
...
/*     */           WorldWater.this.sprites.riverSmallBG.render(r, da + (it.ran() & 0x7) * 16, x, y);
/*     */         } 
/*     */       }  
/*     */     WorldWater.this.LAKE.col.bind();
/*     */     WorldWater.this.sprites.riverSmallFG.render(r, data + (it.ran() & 0x7) * 16, it.x(), it.y());
/*     */     if (o != 0)
/*     */       for (int i = 0; i < DIR.ORTHO.size(); i++) {
/*     */         DIR d = (DIR)DIR.ORTHO.get(i);
/*     */         if ((d.mask() & o) != 0) {
...
/*     */           int y = it.y() + d.y() * 64;
/*     */           int da = d.perpendicular().mask();
/*     */           WorldWater.this.sprites.riverSmallFG.render(r, da + (it.ran() & 0x7) * 16, x, y);
/*     */         } 
/*     */       }  
/*     */     return false;
/*     */   }
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\world\map\terrain\WorldWater$RiverSmall.class
