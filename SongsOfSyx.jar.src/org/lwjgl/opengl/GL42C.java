...
/*     */     }
/* 178 */     nglGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, MemoryUtil.memAddress(params));
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/*     */     try {
/* 186 */       IntBuffer params = stack.callocInt(1);
/* 187 */       nglGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, MemoryUtil.memAddress(params));
/* 188 */       return params.get(0);
/*     */     } finally {
...
/* 231 */     nglDrawElementsInstancedBaseInstance(mode, count, type, indices, primcount, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 236 */     nglDrawElementsInstancedBaseInstance(mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 241 */     nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 246 */     nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 251 */     nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, baseinstance);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 261 */     nglDrawElementsInstancedBaseVertexBaseInstance(mode, count, type, indices, primcount, basevertex, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 266 */     nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 271 */     nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 276 */     nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
/*     */   }
/*     */ 
/*     */   
...
/* 281 */     nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 301 */     nglGetInternalformativ(target, internalformat, pname, params.remaining(), MemoryUtil.memAddress(params));
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/*     */     try {
/* 309 */       IntBuffer params = stack.callocInt(1);
/* 310 */       nglGetInternalformativ(target, internalformat, pname, 1, MemoryUtil.memAddress(params));
/* 311 */       return params.get(0);
/*     */     } finally {
...
/* 319 */     long __functionAddress = (GL.getICD()).glGetActiveAtomicCounterBufferiv;
/* 320 */     if (Checks.CHECKS) {
/* 321 */       Checks.check(__functionAddress);
/* 322 */       Checks.check(params, 1);
/*     */     } 
/* 324 */     JNI.callPV(program, bufferIndex, pname, params, __functionAddress);
/*     */   }
/*     */ 
/*     */   
...
/* 329 */     long __functionAddress = (GL.getICD()).glGetInternalformativ;
/* 330 */     if (Checks.CHECKS) {
/* 331 */       Checks.check(__functionAddress);
/*     */     }
/* 333 */     JNI.callPV(target, internalformat, pname, params.length, params, __functionAddress);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\GL42C.class
