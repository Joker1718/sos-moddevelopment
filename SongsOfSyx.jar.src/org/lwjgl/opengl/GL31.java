...
/* 120 */     GL31C.glDrawArraysInstanced(mode, first, count, primcount);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 127 */     GL31C.nglDrawElementsInstanced(mode, count, type, indices, primcount);
/*     */   }
/*     */ 
/*     */   
...
/* 132 */     GL31C.glDrawElementsInstanced(mode, count, type, indices, primcount);
/*     */   }
/*     */ 
/*     */   
...
/* 137 */     GL31C.glDrawElementsInstanced(mode, type, indices, primcount);
/*     */   }
/*     */ 
/*     */   
...
/* 142 */     GL31C.glDrawElementsInstanced(mode, indices, primcount);
/*     */   }
/*     */ 
/*     */   
...
/* 147 */     GL31C.glDrawElementsInstanced(mode, indices, primcount);
/*     */   }
/*     */ 
/*     */   
...
/* 152 */     GL31C.glDrawElementsInstanced(mode, indices, primcount);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 159 */     GL31C.glCopyBufferSubData(readTarget, writeTarget, readOffset, writeOffset, size);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 166 */     GL31C.glPrimitiveRestartIndex(index);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 173 */     GL31C.glTexBuffer(target, internalformat, buffer);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 180 */     GL31C.nglGetUniformIndices(program, uniformCount, uniformNames, uniformIndices);
/*     */   }
/*     */ 
/*     */   
...
/* 185 */     GL31C.glGetUniformIndices(program, uniformNames, uniformIndices);
/*     */   }
/*     */ 
/*     */   
...
/* 190 */     GL31C.glGetUniformIndices(program, uniformNames, uniformIndices);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 196 */     return GL31C.glGetUniformIndices(program, uniformName);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 203 */     GL31C.nglGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/* 208 */     GL31C.glGetActiveUniformsiv(program, uniformIndices, pname, params);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 214 */     return GL31C.glGetActiveUniformsi(program, uniformIndex, pname);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 221 */     GL31C.nglGetActiveUniformName(program, uniformIndex, bufSize, length, uniformName);
/*     */   }
/*     */ 
/*     */   
...
/* 226 */     GL31C.glGetActiveUniformName(program, uniformIndex, length, uniformName);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 232 */     return GL31C.glGetActiveUniformName(program, uniformIndex, bufSize);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
/*     */   public static String glGetActiveUniformName(@NativeType("GLuint") int program, @NativeType("GLuint") int uniformIndex) {
/* 238 */     return glGetActiveUniformName(program, uniformIndex, glGetActiveUniformsi(program, uniformIndex, 35385));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 245 */     return GL31C.nglGetUniformBlockIndex(program, uniformBlockName);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLuint")
...
/* 251 */     return GL31C.glGetUniformBlockIndex(program, uniformBlockName);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLuint")
...
/* 257 */     return GL31C.glGetUniformBlockIndex(program, uniformBlockName);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 264 */     GL31C.nglGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/* 269 */     GL31C.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 275 */     return GL31C.glGetActiveUniformBlocki(program, uniformBlockIndex, pname);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 282 */     GL31C.nglGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, uniformBlockName);
/*     */   }
/*     */ 
/*     */   
...
/* 287 */     GL31C.glGetActiveUniformBlockName(program, uniformBlockIndex, length, uniformBlockName);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 293 */     return GL31C.glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
/*     */   public static String glGetActiveUniformBlockName(@NativeType("GLuint") int program, @NativeType("GLuint") int uniformBlockIndex) {
/* 299 */     return glGetActiveUniformBlockName(program, uniformBlockIndex, glGetActiveUniformBlocki(program, uniformBlockIndex, 35393));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 306 */     GL31C.glUniformBlockBinding(program, uniformBlockIndex, uniformBlockBinding);
/*     */   }
/*     */ 
/*     */   
...
/* 311 */     GL31C.glGetUniformIndices(program, uniformNames, uniformIndices);
/*     */   }
/*     */ 
/*     */   
...
/* 316 */     GL31C.glGetActiveUniformsiv(program, uniformIndices, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/* 321 */     GL31C.glGetActiveUniformName(program, uniformIndex, length, uniformName);
/*     */   }
/*     */ 
/*     */   
...
/* 326 */     GL31C.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/* 331 */     GL31C.glGetActiveUniformBlockName(program, uniformBlockIndex, length, uniformBlockName);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\GL31.class
