...
/* 112 */     nglCompressedTexImage3D(target, level, internalformat, width, height, depth, border, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 117 */     nglCompressedTexImage3D(target, level, internalformat, width, height, depth, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 127 */     nglCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 132 */     nglCompressedTexImage2D(target, level, internalformat, width, height, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 142 */     nglCompressedTexImage1D(target, level, internalformat, width, border, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 147 */     nglCompressedTexImage1D(target, level, internalformat, width, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */     nglCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 162 */     nglCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, data.remaining(), MemoryUtil.memAddress(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     nglCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 177 */     nglCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, data.remaining(), MemoryUtil.memAddress(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 187 */     nglCompressedTexSubImage1D(target, level, xoffset, width, format, imageSize, data);
/*     */   }
/*     */ 
/*     */   
...
/* 192 */     nglCompressedTexSubImage1D(target, level, xoffset, width, format, data.remaining(), MemoryUtil.memAddress(data));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 203 */       Checks.DEBUG) {
/* 204 */       Checks.check(pixels, GL11.glGetTexLevelParameteri(target, level, 34464));
/*     */     }
/*     */     
/* 207 */     nglGetCompressedTexImage(target, level, MemoryUtil.memAddress(pixels));
/*     */   }
/*     */ 
/*     */   
...
/* 212 */     nglGetCompressedTexImage(target, level, pixels);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\GL13C.class
