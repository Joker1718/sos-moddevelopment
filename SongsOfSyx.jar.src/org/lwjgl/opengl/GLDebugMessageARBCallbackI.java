...
/* 24 */         APIUtil.apiStdcall(), LibFFI.ffi_type_void, new FFIType[] { LibFFI.ffi_type_uint32, LibFFI.ffi_type_uint32, LibFFI.ffi_type_uint32, LibFFI.ffi_type_uint32, LibFFI.ffi_type_sint32, LibFFI.ffi_type_pointer, LibFFI.ffi_type_pointer }));
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 40 */         MemoryUtil.memGetInt(MemoryUtil.memGetAddress(args + (4 * POINTER_SIZE))), 
/* 41 */         MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args + (5 * POINTER_SIZE))), 
/* 42 */         MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args + (6 * POINTER_SIZE))));
/*    */   }
/*    */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\GLDebugMessageARBCallbackI.class
