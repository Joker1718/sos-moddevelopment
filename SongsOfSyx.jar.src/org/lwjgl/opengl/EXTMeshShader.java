...
/*     */   
/*     */   public static native void glMultiDrawMeshTasksIndirectCountEXT(@NativeType("GLintptr") long paramLong1, @NativeType("GLintptr") long paramLong2, @NativeType("GLsizei") int paramInt1, @NativeType("GLsizei") int paramInt2);
/*     */   
/*     */   public static native void glMultiDrawMeshTasksIndirectEXT(@NativeType("GLintptr") long paramLong, @NativeType("GLsizei") int paramInt1, @NativeType("GLsizei") int paramInt2);
/*     */   
/*     */   public static native void glDrawMeshTasksIndirectEXT(@NativeType("GLintptr") long paramLong);
/*     */   
/*     */   public static native void glDrawMeshTasksEXT(@NativeType("GLuint") int paramInt1, @NativeType("GLuint") int paramInt2, @NativeType("GLuint") int paramInt3);
/*     */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\EXTMeshShader.class
