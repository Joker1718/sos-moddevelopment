...
/*    */   
/*    */   public static native void glMemoryBarrierEXT(@NativeType("GLbitfield") int paramInt);
/*    */   
/*    */   public static native void glBindImageTextureEXT(@NativeType("GLuint") int paramInt1, @NativeType("GLuint") int paramInt2, @NativeType("GLint") int paramInt3, @NativeType("GLboolean") boolean paramBoolean, @NativeType("GLint") int paramInt4, @NativeType("GLenum") int paramInt5, @NativeType("GLint") int paramInt6);
/*    */   
...
/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\EXTShaderImageLoadStore.class
