...
/*  79 */     GL43C.nglGetProgramInterfaceiv(program, programInterface, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/*  84 */     GL43C.glGetProgramInterfaceiv(program, programInterface, pname, params);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/*  90 */     return GL43C.glGetProgramInterfacei(program, programInterface, pname);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     return GL43C.nglGetProgramResourceIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLuint")
...
/* 103 */     return GL43C.glGetProgramResourceIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLuint")
...
/* 109 */     return GL43C.glGetProgramResourceIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 116 */     GL43C.nglGetProgramResourceName(program, programInterface, index, bufSize, length, name);
/*     */   }
/*     */ 
/*     */   
...
/* 121 */     GL43C.glGetProgramResourceName(program, programInterface, index, length, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 127 */     return GL43C.glGetProgramResourceName(program, programInterface, index, bufSize);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("void")
...
/* 133 */     return glGetProgramResourceName(program, programInterface, index, glGetProgramInterfacei(program, programInterface, 37622));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 140 */     GL43C.nglGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length, params);
/*     */   }
/*     */ 
/*     */   
...
/* 145 */     GL43C.glGetProgramResourceiv(program, programInterface, index, props, length, params);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 152 */     return GL43C.nglGetProgramResourceLocation(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLint")
...
/* 158 */     return GL43C.glGetProgramResourceLocation(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLint")
...
/* 164 */     return GL43C.glGetProgramResourceLocation(program, programInterface, name);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 171 */     return GL43C.nglGetProgramResourceLocationIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLint")
...
/* 177 */     return GL43C.glGetProgramResourceLocationIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   @NativeType("GLint")
...
/* 183 */     return GL43C.glGetProgramResourceLocationIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
...
/* 188 */     GL43C.glGetProgramInterfaceiv(program, programInterface, pname, params);
/*     */   }
/*     */ 
/*     */   
...
/* 193 */     GL43C.glGetProgramResourceName(program, programInterface, index, length, name);
/*     */   }
/*     */ 
/*     */   
...
/* 198 */     GL43C.glGetProgramResourceiv(program, programInterface, index, props, length, params);
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\ARBProgramInterfaceQuery.class
