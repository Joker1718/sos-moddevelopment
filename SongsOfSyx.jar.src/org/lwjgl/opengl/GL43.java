...
/*  356 */     GL43C.nglClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  361 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  366 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  371 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  376 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  383 */     GL43C.nglClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  388 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  393 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  398 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  403 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  410 */     GL43C.glDispatchCompute(num_groups_x, num_groups_y, num_groups_z);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  417 */     GL43C.glDispatchComputeIndirect(indirect);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  424 */     GL43C.glCopyImageSubData(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  431 */     GL43C.nglDebugMessageControl(source, type, severity, count, ids, enabled);
/*      */   }
/*      */ 
/*      */   
...
/*  436 */     GL43C.glDebugMessageControl(source, type, severity, ids, enabled);
/*      */   }
/*      */ 
/*      */   
...
/*  441 */     GL43C.glDebugMessageControl(source, type, severity, id, enabled);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  448 */     GL43C.nglDebugMessageInsert(source, type, id, severity, length, message);
/*      */   }
/*      */ 
/*      */   
...
/*  453 */     GL43C.glDebugMessageInsert(source, type, id, severity, message);
/*      */   }
/*      */ 
/*      */   
...
/*  458 */     GL43C.glDebugMessageInsert(source, type, id, severity, message);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  465 */     GL43C.nglDebugMessageCallback(callback, userParam);
/*      */   }
/*      */ 
/*      */   
...
/*  470 */     GL43C.glDebugMessageCallback(callback, userParam);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  477 */     return GL43C.nglGetDebugMessageLog(count, bufsize, sources, types, ids, severities, lengths, messageLog);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLuint")
...
/*  483 */     return GL43C.glGetDebugMessageLog(count, sources, types, ids, severities, lengths, messageLog);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  490 */     GL43C.nglPushDebugGroup(source, id, length, message);
/*      */   }
/*      */ 
/*      */   
...
/*  495 */     GL43C.glPushDebugGroup(source, id, message);
/*      */   }
/*      */ 
/*      */   
...
/*  500 */     GL43C.glPushDebugGroup(source, id, message);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  514 */     GL43C.nglObjectLabel(identifier, name, length, label);
/*      */   }
/*      */ 
/*      */   
...
/*  519 */     GL43C.glObjectLabel(identifier, name, label);
/*      */   }
/*      */ 
/*      */   
...
/*  524 */     GL43C.glObjectLabel(identifier, name, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  531 */     GL43C.nglGetObjectLabel(identifier, name, bufSize, length, label);
/*      */   }
/*      */ 
/*      */   
...
/*  536 */     GL43C.glGetObjectLabel(identifier, name, length, label);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
...
/*  542 */     return GL43C.glGetObjectLabel(identifier, name, bufSize);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
/*      */   public static String glGetObjectLabel(@NativeType("GLenum") int identifier, @NativeType("GLuint") int name) {
/*  548 */     return glGetObjectLabel(identifier, name, GL11.glGetInteger(33512));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  572 */     GL43C.nglGetObjectPtrLabel(ptr, bufSize, length, label);
/*      */   }
/*      */ 
/*      */   
...
/*  596 */     GL43C.glFramebufferParameteri(target, pname, param);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  603 */     GL43C.nglGetFramebufferParameteriv(target, pname, params);
/*      */   }
/*      */ 
/*      */   
...
/*  608 */     GL43C.glGetFramebufferParameteriv(target, pname, params);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
/*      */   public static int glGetFramebufferParameteri(@NativeType("GLenum") int target, @NativeType("GLenum") int pname) {
/*  614 */     return GL43C.glGetFramebufferParameteri(target, pname);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  621 */     GL43C.nglGetInternalformati64v(target, internalformat, pname, bufSize, params);
/*      */   }
/*      */ 
/*      */   
...
/*  626 */     GL43C.glGetInternalformati64v(target, internalformat, pname, params);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
...
/*  632 */     return GL43C.glGetInternalformati64(target, internalformat, pname);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */     GL43C.glInvalidateTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  646 */     GL43C.glInvalidateTexImage(texture, level);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  653 */     GL43C.glInvalidateBufferSubData(buffer, offset, length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  660 */     GL43C.glInvalidateBufferData(buffer);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */     GL43C.nglInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height);
/*      */   }
/*      */ 
/*      */   
...
/*  689 */     GL43C.glInvalidateSubFramebuffer(target, attachments, x, y, width, height);
/*      */   }
/*      */ 
/*      */   
...
/*  694 */     GL43C.glInvalidateSubFramebuffer(target, attachment, x, y, width, height);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  701 */     GL43C.nglMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  706 */     GL43C.glMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  711 */     GL43C.glMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  716 */     GL43C.glMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  723 */     GL43C.nglMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  728 */     GL43C.glMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  733 */     GL43C.glMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/*  738 */     GL43C.glMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  745 */     GL43C.nglGetProgramInterfaceiv(program, programInterface, pname, params);
/*      */   }
/*      */ 
/*      */   
...
/*  750 */     GL43C.glGetProgramInterfaceiv(program, programInterface, pname, params);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
...
/*  756 */     return GL43C.glGetProgramInterfacei(program, programInterface, pname);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  763 */     return GL43C.nglGetProgramResourceIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLuint")
...
/*  769 */     return GL43C.glGetProgramResourceIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLuint")
...
/*  775 */     return GL43C.glGetProgramResourceIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  782 */     GL43C.nglGetProgramResourceName(program, programInterface, index, bufSize, length, name);
/*      */   }
/*      */ 
/*      */   
...
/*  787 */     GL43C.glGetProgramResourceName(program, programInterface, index, length, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
...
/*  793 */     return GL43C.glGetProgramResourceName(program, programInterface, index, bufSize);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("void")
...
/*  799 */     return glGetProgramResourceName(program, programInterface, index, glGetProgramInterfacei(program, programInterface, 37622));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  806 */     GL43C.nglGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length, params);
/*      */   }
/*      */ 
/*      */   
...
/*  811 */     GL43C.glGetProgramResourceiv(program, programInterface, index, props, length, params);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  818 */     return GL43C.nglGetProgramResourceLocation(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLint")
...
/*  824 */     return GL43C.glGetProgramResourceLocation(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLint")
...
/*  830 */     return GL43C.glGetProgramResourceLocation(program, programInterface, name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  837 */     return GL43C.nglGetProgramResourceLocationIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLint")
...
/*  843 */     return GL43C.glGetProgramResourceLocationIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLint")
...
/*  849 */     return GL43C.glGetProgramResourceLocationIndex(program, programInterface, name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  856 */     GL43C.glShaderStorageBlockBinding(program, storageBlockIndex, storageBlockBinding);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  863 */     GL43C.glTexBufferRange(target, internalformat, buffer, offset, size);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  870 */     GL43C.glTexStorage2DMultisample(target, samples, internalformat, width, height, fixedsamplelocations);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  877 */     GL43C.glTexStorage3DMultisample(target, samples, internalformat, width, height, depth, fixedsamplelocations);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  884 */     GL43C.glTextureView(texture, target, origtexture, internalformat, minlevel, numlevels, minlayer, numlayers);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  891 */     GL43C.glBindVertexBuffer(bindingindex, buffer, offset, stride);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  898 */     GL43C.glVertexAttribFormat(attribindex, size, type, normalized, relativeoffset);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  905 */     GL43C.glVertexAttribIFormat(attribindex, size, type, relativeoffset);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  912 */     GL43C.glVertexAttribLFormat(attribindex, size, type, relativeoffset);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  919 */     GL43C.glVertexAttribBinding(attribindex, bindingindex);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  926 */     GL43C.glVertexBindingDivisor(bindingindex, divisor);
/*      */   }
/*      */ 
/*      */   
...
/*  931 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  936 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  941 */     GL43C.glClearBufferData(target, internalformat, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  946 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  951 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  956 */     GL43C.glClearBufferSubData(target, internalformat, offset, size, format, type, data);
/*      */   }
/*      */ 
/*      */   
...
/*  961 */     GL43C.glDebugMessageControl(source, type, severity, ids, enabled);
/*      */   }
/*      */ 
/*      */   
/*      */   @NativeType("GLuint")
...
/*  967 */     return GL43C.glGetDebugMessageLog(count, sources, types, ids, severities, lengths, messageLog);
/*      */   }
/*      */ 
/*      */   
...
/*  972 */     GL43C.glGetObjectLabel(identifier, name, length, label);
/*      */   }
/*      */ 
/*      */   
...
/*  977 */     GL43C.glGetObjectPtrLabel(ptr, length, label);
/*      */   }
/*      */ 
/*      */   
...
/*  982 */     GL43C.glGetFramebufferParameteriv(target, pname, params);
/*      */   }
/*      */ 
/*      */   
...
/*  987 */     GL43C.glGetInternalformati64v(target, internalformat, pname, params);
/*      */   }
/*      */ 
/*      */   
/*      */   public static void glInvalidateFramebuffer(@NativeType("GLenum") int target, @NativeType("GLenum const *") int[] attachments) {
/*  992 */     GL43C.glInvalidateFramebuffer(target, attachments);
/*      */   }
/*      */ 
/*      */   
...
/*  997 */     GL43C.glInvalidateSubFramebuffer(target, attachments, x, y, width, height);
/*      */   }
/*      */ 
/*      */   
...
/* 1002 */     GL43C.glMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/* 1007 */     GL43C.glMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
/*      */   }
/*      */ 
/*      */   
...
/* 1012 */     GL43C.glGetProgramInterfaceiv(program, programInterface, pname, params);
/*      */   }
/*      */ 
/*      */   
...
/* 1017 */     GL43C.glGetProgramResourceName(program, programInterface, index, length, name);
/*      */   }
/*      */ 
/*      */   
...
/* 1022 */     GL43C.glGetProgramResourceiv(program, programInterface, index, props, length, params);
/*      */   }
/*      */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\opengl\GL43.class
