...
/*     */ 
/*     */   
/*     */   protected IOTimespec create(long address, ByteBuffer container) {
/*  58 */     return new IOTimespec(address, container);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   public IOTimespec tv_sec(@NativeType("__u64") long value) {
/*  82 */     ntv_sec(address(), value); return this;
/*     */   } public IOTimespec tv_nsec(@NativeType("__u64") long value) {
...
/* 113 */     return new IOTimespec(MemoryUtil.nmemAllocChecked(SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static IOTimespec calloc() {
/* 118 */     return new IOTimespec(MemoryUtil.nmemCallocChecked(1L, SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static IOTimespec create() {
/* 123 */     ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
/* 124 */     return new IOTimespec(MemoryUtil.memAddress(container), container);
/*     */   }
/*     */ 
/*     */   
/*     */   public static IOTimespec create(long address) {
/* 129 */     return new IOTimespec(address, null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static IOTimespec createSafe(long address) {
/* 134 */     return (address == 0L) ? null : new IOTimespec(address, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 186 */     return new IOTimespec(stack.nmalloc(ALIGNOF, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 195 */     return new IOTimespec(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     implements NativeResource
/*     */   {
/* 235 */     private static final IOTimespec ELEMENT_FACTORY = IOTimespec.create(-1L);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 247 */       super(container, container.remaining() / IOTimespec.SIZEOF);
/*     */     }
/*     */     
...
/*     */     @NativeType("__u64")
/*     */     public long tv_sec() {
/* 275 */       return IOTimespec.ntv_sec(address());
/*     */     } @NativeType("__u64")
/*     */     public long tv_nsec() {
/* 278 */       return IOTimespec.ntv_nsec(address());
/*     */     }
/*     */     public Buffer tv_sec(@NativeType("__u64") long value) {
/* 281 */       IOTimespec.ntv_sec(address(), value); return this;
/*     */     } public Buffer tv_nsec(@NativeType("__u64") long value) {
/* 283 */       IOTimespec.ntv_nsec(address(), value); return this;
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\system\linux\liburing\IOTimespec.class
