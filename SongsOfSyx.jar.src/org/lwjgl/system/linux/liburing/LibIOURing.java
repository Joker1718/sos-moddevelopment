...
/*     */ 
/*     */   
/*     */   public static int io_uring_setup(@NativeType("int *") IntBuffer _errno, @NativeType("unsigned") int entries, @NativeType("struct io_uring_params *") IOURingParams p) {
/* 356 */     if (Checks.CHECKS) {
/* 357 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 359 */     return nio_uring_setup(MemoryUtil.memAddressSafe(_errno), entries, p.address());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int io_uring_register(@NativeType("int *") IntBuffer _errno, int fd, @NativeType("unsigned") int opcode, @NativeType("void *") long arg, @NativeType("unsigned") int nr_args) {
/* 369 */     if (Checks.CHECKS) {
/* 370 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 372 */     return nio_uring_register(MemoryUtil.memAddressSafe(_errno), fd, opcode, arg, nr_args);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int io_uring_enter2(@NativeType("int *") IntBuffer _errno, int fd, @NativeType("unsigned") int to_submit, @NativeType("unsigned") int min_complete, @NativeType("unsigned") int flags, @NativeType("sigset_t *") long sig, int sz) {
/* 382 */     if (Checks.CHECKS) {
/* 383 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 385 */     return nio_uring_enter2(MemoryUtil.memAddressSafe(_errno), fd, to_submit, min_complete, flags, sig, sz);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int io_uring_enter(@NativeType("int *") IntBuffer _errno, int fd, @NativeType("unsigned") int to_submit, @NativeType("unsigned") int min_complete, @NativeType("unsigned") int flags, @NativeType("sigset_t *") long sig) {
/* 395 */     if (Checks.CHECKS) {
/* 396 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 398 */     return nio_uring_enter(MemoryUtil.memAddressSafe(_errno), fd, to_submit, min_complete, flags, sig);
/*     */   }
/*     */   
/*     */   public static native int nio_uring_setup(long paramLong1, int paramInt, long paramLong2);
/*     */   
/*     */   public static native int nio_uring_register(long paramLong1, int paramInt1, int paramInt2, long paramLong2, int paramInt3);
/*     */   
/*     */   public static native int nio_uring_enter2(long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong2, int paramInt5);
/*     */   
/*     */   public static native int nio_uring_enter(long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong2);
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\system\linux\liburing\LibIOURing.class
