...
/*     */ 
/*     */   
/*     */   public static int open(@NativeType("int *") IntBuffer _errno, @NativeType("char const *") ByteBuffer pathname, int flags, @NativeType("mode_t") int mode) {
/* 163 */     if (Checks.CHECKS) {
/* 164 */       Checks.checkSafe(_errno, 1);
/* 165 */       Checks.checkNT1(pathname);
/*     */     } 
/* 167 */     return nopen(MemoryUtil.memAddressSafe(_errno), MemoryUtil.memAddress(pathname), flags, mode);
/*     */   }
/*     */ 
/*     */   
/*     */   public static int open(@NativeType("int *") IntBuffer _errno, @NativeType("char const *") CharSequence pathname, int flags, @NativeType("mode_t") int mode) {
/* 172 */     if (Checks.CHECKS) {
/* 173 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 175 */     MemoryStack stack = MemoryStack.stackGet(); int stackPointer = stack.getPointer();
/*     */     try {
/* 177 */       stack.nUTF8(pathname, true);
/* 178 */       long pathnameEncoded = stack.getPointerAddress();
/* 179 */       return nopen(MemoryUtil.memAddressSafe(_errno), pathnameEncoded, flags, mode);
/*     */     } finally {
...
/*     */ 
/*     */   
/*     */   public static int openat(@NativeType("int *") IntBuffer _errno, int dirfd, @NativeType("char const *") ByteBuffer pathname, int flags, @NativeType("mode_t") int mode) {
/* 192 */     if (Checks.CHECKS) {
/* 193 */       Checks.checkSafe(_errno, 1);
/* 194 */       Checks.checkNT1(pathname);
/*     */     } 
/* 196 */     return nopenat(MemoryUtil.memAddressSafe(_errno), dirfd, MemoryUtil.memAddress(pathname), flags, mode);
/*     */   }
/*     */ 
/*     */   
/*     */   public static int openat(@NativeType("int *") IntBuffer _errno, int dirfd, @NativeType("char const *") CharSequence pathname, int flags, @NativeType("mode_t") int mode) {
/* 201 */     if (Checks.CHECKS) {
/* 202 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 204 */     MemoryStack stack = MemoryStack.stackGet(); int stackPointer = stack.getPointer();
/*     */     try {
/* 206 */       stack.nUTF8(pathname, true);
/* 207 */       long pathnameEncoded = stack.getPointerAddress();
/* 208 */       return nopenat(MemoryUtil.memAddressSafe(_errno), dirfd, pathnameEncoded, flags, mode);
/*     */     } finally {
...
/*     */ 
/*     */   
/*     */   public static int creat(@NativeType("int *") IntBuffer _errno, @NativeType("char const *") ByteBuffer pathname, @NativeType("mode_t") int mode) {
/* 221 */     if (Checks.CHECKS) {
/* 222 */       Checks.checkSafe(_errno, 1);
/* 223 */       Checks.checkNT1(pathname);
/*     */     } 
/* 225 */     return ncreat(MemoryUtil.memAddressSafe(_errno), MemoryUtil.memAddress(pathname), mode);
/*     */   }
/*     */ 
/*     */   
/*     */   public static int creat(@NativeType("int *") IntBuffer _errno, @NativeType("char const *") CharSequence pathname, @NativeType("mode_t") int mode) {
/* 230 */     if (Checks.CHECKS) {
/* 231 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 233 */     MemoryStack stack = MemoryStack.stackGet(); int stackPointer = stack.getPointer();
/*     */     try {
/* 235 */       stack.nUTF8(pathname, true);
/* 236 */       long pathnameEncoded = stack.getPointerAddress();
/* 237 */       return ncreat(MemoryUtil.memAddressSafe(_errno), pathnameEncoded, mode);
/*     */     } finally {
/* 239 */       stack.setPointer(stackPointer);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int fcntl(@NativeType("int *") IntBuffer _errno, int fd, int cmd) {
/* 250 */     if (Checks.CHECKS) {
/* 251 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 253 */     return nfcntl(MemoryUtil.memAddressSafe(_errno), fd, cmd);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int fcntli(@NativeType("int *") IntBuffer _errno, int fd, int cmd, int arg) {
/* 263 */     if (Checks.CHECKS) {
/* 264 */       Checks.checkSafe(_errno, 1);
/*     */     }
/* 266 */     return nfcntli(MemoryUtil.memAddressSafe(_errno), fd, cmd, arg);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static int fcntlp(@NativeType("int *") IntBuffer _errno, int fd, int cmd, @NativeType("void *") long arg) {
/* 276 */     if (Checks.CHECKS) {
/* 277 */       Checks.checkSafe(_errno, 1);
/* 278 */       Checks.check(arg);
/*     */     } 
/* 280 */     return nfcntlp(MemoryUtil.memAddressSafe(_errno), fd, cmd, arg);
/*     */   }
/*     */   
/*     */   public static native int nopen(long paramLong1, long paramLong2, int paramInt1, int paramInt2);
/*     */   
/*     */   public static native int nopenat(long paramLong1, int paramInt1, long paramLong2, int paramInt2, int paramInt3);
/*     */   
/*     */   public static native int ncreat(long paramLong1, long paramLong2, int paramInt);
/*     */   
/*     */   public static native int nfcntl(long paramLong, int paramInt1, int paramInt2);
/*     */   
/*     */   public static native int nfcntli(long paramLong, int paramInt1, int paramInt2, int paramInt3);
/*     */   
/*     */   public static native int nfcntlp(long paramLong1, int paramInt1, int paramInt2, long paramLong2);
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\system\linux\FCNTL.class
