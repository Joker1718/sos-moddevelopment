...
/*     */   }
/*     */   
/*     */   protected XCirculateEvent(long address, ByteBuffer container) {
/*  73 */     super(address, container);
/*     */   }
/*     */ 
/*     */   
/*     */   protected XCirculateEvent create(long address, ByteBuffer container) {
/*  78 */     return new XCirculateEvent(address, container);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 166 */     return new XCirculateEvent(MemoryUtil.nmemAllocChecked(SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XCirculateEvent calloc() {
/* 171 */     return new XCirculateEvent(MemoryUtil.nmemCallocChecked(1L, SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XCirculateEvent create() {
/* 176 */     ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
/* 177 */     return new XCirculateEvent(MemoryUtil.memAddress(container), container);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XCirculateEvent create(long address) {
/* 182 */     return new XCirculateEvent(address, null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XCirculateEvent createSafe(long address) {
/* 187 */     return (address == 0L) ? null : new XCirculateEvent(address, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     return new XCirculateEvent(stack.nmalloc(ALIGNOF, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     return new XCirculateEvent(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     implements NativeResource
/*     */   {
/* 317 */     private static final XCirculateEvent ELEMENT_FACTORY = XCirculateEvent.create(-1L);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 329 */       super(container, container.remaining() / XCirculateEvent.SIZEOF);
/*     */     }
/*     */     
...
/*     */     
/*     */     public int type() {
/* 356 */       return XCirculateEvent.ntype(address());
/*     */     } @NativeType("unsigned long")
/*     */     public long serial() {
/* 359 */       return XCirculateEvent.nserial(address());
/*     */     } @NativeType("Bool")
/*     */     public boolean send_event() {
/* 362 */       return (XCirculateEvent.nsend_event(address()) != 0);
/*     */     } @NativeType("Display *")
/*     */     public long display() {
/* 365 */       return XCirculateEvent.ndisplay(address());
/*     */     } @NativeType("Window")
/*     */     public long event() {
/* 368 */       return XCirculateEvent.nevent(address());
/*     */     } @NativeType("Window")
/*     */     public long window() {
/* 371 */       return XCirculateEvent.nwindow(address());
/*     */     } public int place() {
/* 373 */       return XCirculateEvent.nplace(address());
/*     */     }
/*     */     public Buffer type(int value) {
/* 376 */       XCirculateEvent.ntype(address(), value); return this;
/*     */     } public Buffer serial(@NativeType("unsigned long") long value) {
/* 378 */       XCirculateEvent.nserial(address(), value); return this;
/*     */     } public Buffer send_event(@NativeType("Bool") boolean value) {
/* 380 */       XCirculateEvent.nsend_event(address(), value ? 1 : 0); return this;
/*     */     } public Buffer display(@NativeType("Display *") long value) {
/* 382 */       XCirculateEvent.ndisplay(address(), value); return this;
/*     */     } public Buffer event(@NativeType("Window") long value) {
/* 384 */       XCirculateEvent.nevent(address(), value); return this;
/*     */     } public Buffer window(@NativeType("Window") long value) {
/* 386 */       XCirculateEvent.nwindow(address(), value); return this;
/*     */     } public Buffer place(int value) {
/* 388 */       XCirculateEvent.nplace(address(), value); return this;
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tasks\Works.Dump\SongsOfSyx\mods_development\SongsOfSyx.jar!\org\lwjgl\system\linux\XCirculateEvent.class
